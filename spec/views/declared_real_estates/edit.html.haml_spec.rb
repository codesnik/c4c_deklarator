...
describe "declared_real_estates/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit declared_real_estate form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => declared_real_estates_path(@declared_real_estate), :method => "post" do
